document.addEventListener('DOMContentLoaded', () => {
  ...
  // wides & no balls don't consume a ball
  ...
  document.getElementById('btn-bye').onclick = () => scoreExtras(1);
  document.getElementById('btn-leg-bye').onclick = () => scoreExtras(1);
